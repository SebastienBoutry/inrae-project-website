...
This web page uses the HAL API to retrieve the project's bibliographic references. To do this, you need to enter the following two parameters (hal_project_name and hal_collection) in the YAML. 
